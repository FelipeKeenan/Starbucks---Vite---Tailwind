        ...
        <section className="sm:grid sm:grid-cols-2 px-4 sm:px-0">
            ...
            <div>
                <div className="flex flex-col items-center justify-start pb-9 text-center md:px-4">
                    ...
                    <h2 className="font-black text-xl uppercase mb-8">
                        Apresentando Vanilla Sweet <br /> Cream Cold Brew - Doce, <br /> Cremoso, Frio, Ousado.
                    </h2>
                    <p className="font-extralight tracking-wider text-[#111111]">Pouco antes de servir, nossa mistura<br /> personalizada de café Starbucks® Cold Brew é coberta <br /> com uma camada delicada de creme doce de baunilha.
                    </p>
